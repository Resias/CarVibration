...
def testing_all(config):
    ...
    for c in config:
        ...
        for backbone in backbones:
            ...
            loss_graph(folder_name, backbone, n_fft, hop_length, batch_size, kernel_size, stride_size)
            
            #validation part
            epo_list = [None,"Epoch_150.pth","Epoch_160.pth","Epoch_170.pth","Epoch_180.pth","Epoch_190.pth"]
            for epo in epo_list:
                pth_paths = os.path.join(os.getcwd(), folder_name, self.experiment_name, str(epo))
